          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {followerAccounts.map((follower: any) => (
                <Card key={follower.id} className="flex flex-col h-full hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="pt-3 flex-grow text-xs space-y-2">
                    <div className="space-y-1">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono truncate">{follower.clientId || '-'}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Status:</span>
                        <span className={`font-medium ${follower.consentGiven ? 'text-green-600' : 'text-yellow-600'}`}>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{follower.perAccountCap || '100,000'}</span>
                      </div>
                    </div>
                    <div className="pt-2 border-t">
                      <p className="text-muted-foreground text-xs font-medium">Auto-replicates master trades →</p>
                    </div>
                  </CardContent>
                </Card>
              ))}
